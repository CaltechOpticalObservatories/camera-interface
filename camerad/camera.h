...
namespace Camera {
  ...
  /**
   * @brief   forward declaration of Information class so Camera class can use it
   */
  class Information;
  ...
  /**
   * @class   Camera
   * @brief   this class describes some top-level settings
   *
   */
  class Camera {
    private:
    ...
    public:
      ...
      /// true saves image in date subdir below image_dir, i.e. image_dir/YYYYMMDD/
      bool autodir_state;

      bool abortstate;                      /// true aborts the current operation (exposure, readout, etc.)
  ...
  /**
   * @class   Information
   * @brief   holds necessary information for exposure
   * @details This class contains all information needed for an exposure and
   *          resultant FITS file. Since the FITS object will make use of it,
   *          a copy can be made just for the FITS object. A copy constructor
  ...
  class Information {
    ...
    public:
      ...
      bool iscube;                          // obsolete -- used for old fits.h only
      ...
      /***** Camera::Information (constructor) ********************************/
      /**
       * @brief   Camera::Information class constructor and initializer list
       */
      Information()
...
//        sampmode_frames(-1)
      ...
      /**
       * @brief   Camera::Information copy constructor
       */
      ...
      /**
       * @brief   Camera::Information copy assignment operator
       */
